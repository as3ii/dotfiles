# Generated by Powerlevel10k configuration wizard on 2019-09-08 at 19:24 CEST.
...
# angled separators, sharp heads, sharp tails, 2 lines, solid, left frame, compact,
# many icons, concise.
...
() {
  ...
  typeset -ga POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
      ...
      dir_writable            # display lock if no write permission
      vcs                     # git status
      #vi_mode
      # =========================[ Line #2 ]=========================
      newline
